...
import { RegisterUserOnMailingList } from '../../../../src/domain/register-user-on-mailing-list/register-user-on-mailing-list'
import { UserData } from '../../../../src/domain/register-user-on-mailing-list/user-data'
